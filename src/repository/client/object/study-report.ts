...
export interface StudyReport {
  ...
  searchText: string
  getRgPointYn: boolean
  fullEasyName: string
  studyDays: number
}

export function makeStudyReport(json?: any): StudyReport {
  return {
    ...
    getRgPointYn: RenewType.renewBoolean(json?.GetRgPointYn),
    fullEasyName: RenewType.renewString(json?.FullEasyName),
    studyDays: RenewType.renewNumber(json?.studyDays),
  }
}
